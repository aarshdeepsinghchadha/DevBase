...
try
{
    ...
    string connectionString = hostConfiguration.Configuration.GetConnectionString("DevBaseDb") ?? throw new ArgumentNullException(nameof(connectionString));
